...
const LoginForm = () => {
  ...
  return (
    <div className='flex justify-center items-center min-h-screen'>
      <form className="w-[420px] bg-white/30 text-black rounded-lg p-8 backdrop-blur-3xl" onSubmit={handleSubmit}>
        ...
        <div className="text-sm text-center mt-7 mb-3 pt-3">
          <p>Don't have an account?
            <a href="#" className="text-white font-semibold hover:underline ml-1">Register</a>
          </p>
        </div>
      </form>
    </div>
