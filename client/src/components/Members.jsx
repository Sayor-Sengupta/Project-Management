      ...
      <div className="flex flex-row gap-12 justify-between">
        <div className="flex flex-col gap-2 items-center">
          ...
          {members.map((member, index) => (
            <div className="h-12 w-48 bg-cyan-800 flex justify-center items-center rounded-md" key={index}>
          ...
          <div>
            ...
            <div className="flex flex-col items-center gap-4">
              <h1 className="bg-gray-500 p-2 w-44 rounded-lg text-center hover:bg-gray-600 border" onClick = {showLoading1}>
          ...
          <AddTaskModal open={modalVisible1} setOpen={setModalVisible1} projectId={projectId}/>
        </div>
